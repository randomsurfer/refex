...
if __name__ == "__main__":
    ...
    argument_parser.add_argument('-eep', '--eep-file', help='rider file/eep', required=True)
    ...
    binned_fx_matrix = fx.only_eep(graph_file, eep_file, bins)
