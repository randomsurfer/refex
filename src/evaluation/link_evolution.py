...
if __name__ == "__main__":
    argument_parser = argparse.ArgumentParser(prog='link evolution')
    argument_parser.add_argument('-g1', '--graph-one', help='graph G1', required=True)
    argument_parser.add_argument('-g2', '--graph-two', help='graph G2', required=True)
    ...
    graph_t1 = args.graph_one
    graph_t2 = args.graph_two
